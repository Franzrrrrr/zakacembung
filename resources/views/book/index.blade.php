...
<body class="h h-screen font-outfit">
    <section class="p-10">
        ...
        <div class="grid grid-cols-5 h-[45vh] bg-[rgb(255,242,221)] rounded-md overflow-hidden shadow-lg mt-4">
...
<div class="flex justify-center items-center my-1">
    ...
    />
      ...
      <div class="inset-0 flex flex-col items-center justify-center pt-6">
        ...
        <p class="text-lg font-bold text-[#99622e]">{{ $progress }}%</p>
        <p class="text-xs text-gray-500">{{ $behindSchedule }} behind schedule</p>
      </div>
    </div>
  </div>  
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <form action="{{ route('goal.store') }}" method="POST" class="space-y-4">
                        ...
                        <!-- Select Books for Goal -->
                        <div>
                            <label for="books" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Pilih Buku</label>
                            <select name="books[]" id="books" multiple class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-purple-500 focus:border-purple-500 sm:text-sm">
